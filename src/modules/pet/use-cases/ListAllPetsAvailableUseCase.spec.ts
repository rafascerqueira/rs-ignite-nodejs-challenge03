...
import { ListAllPetsAvailableUseCase } from "./ListAllPetsAvailableUseCase";
import { CreatePetUseCase } from "./CreatePetUseCase";
import { CreateOrgUseCase } from "@modules/org/use-cases/CreateOrgUseCase";

describe("ListAllPetsAvailableUseCase", () => {
  let listAllPetsAvailableUseCase: ListAllPetsAvailableUseCase;
  ...
  beforeEach(async () => {
    ...
    listAllPetsAvailableUseCase = new ListAllPetsAvailableUseCase(
      petRepository
    );
  });
  ...
  it("should be able to list all pets available", async () => {
    ...
    const pets = await listAllPetsAvailableUseCase.execute("Celestynów");
